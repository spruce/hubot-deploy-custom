...
options = properties.parse fs.readFileSync("../deploy.conf", { encoding: "utf8" }), {sections: true, comments: ";", separators: "", strict: true}
...
module.exports = (robot) ->
  ...
  robot.router.post "/deploy", (req, res) ->
    ...
    # search properties for deployhook name == hook.repository.name
    for key, value of properties when value.deployhook is hook.repository.name
